[![Build Status](https://travis-ci.com/mtumilowicz/java11-vavr-pattern-matching.svg?branch=master)](https://travis-ci.com/mtumilowicz/java11-vavr-pattern-matching)
